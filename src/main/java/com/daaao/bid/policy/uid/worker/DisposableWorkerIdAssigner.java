...
import com.daaao.bid.policy.uid.worker.entity.WorkerNodeEntity;
import com.daaao.bid.policy.uid.utils.DockerUtils;
import com.daaao.bid.policy.uid.utils.NetUtils;
import com.daaao.bid.policy.uid.worker.dao.WorkerNodeDAO;
...
public class DisposableWorkerIdAssigner implements WorkerIdAssigner {
    ...
    public DisposableWorkerIdAssigner() {
        LOGGER.info("DisposableWorkerIdAssigner initializing...");
    }
